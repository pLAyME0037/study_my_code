...
const char *migrations[] = {
    ...
    "    medicine_import_id INTEGER PRIMARY KEY ASC,\n"
    "    medicine_id INTEGER PRIMARY KEY ASC,\n"
    "    qty NUMERIC,\n"
    "    price REAL,\n"
    "    FOREIGN KEY(medicine_import_id) REFERENCES MedicineImportDetails,\n"
    ...
    "    organization_daily_id INTEGER PRIMARY KEY ASC,\n"
    "    ill_id INTEGER,\n"
    "    price REAL,\n"
    "    currency TEXT,\n"
